...
<head>
    ...
    <title>Sickness Leave Form</title>
...
<body>
    <div class="container">
        <div class="header">
            ...
            <h2>Sickness Leave Form</h2>
        </div>

        <div class="content">
            <p class="label">Patient Name: <span class="value">{{ isset($leave->patient) && isset($leave->patient->person) ? $leave->patient->person->getName() : "" }}</span></p>

            <p class="label">Patient ID: <span class="value">{{ isset($leave->patient) && isset($leave->patient->person) ? $leave->patient->person->identifier_number : ""}}</span></p>
